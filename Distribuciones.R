...
# matemáticas. Cada pregunta tiene cinco posibles respuestas y solo
# una de ellas es correcta. Encuentre la probabilidad de tener
# cuatro o menos respuestas correctas si un estudio intento
# responder a cada pregunta al azar.

# Solución para que saque 4 respuestas correctas:

# Dado que sólo uno de cada cinco respuestas posibles es correcta, la
# probabilidad de responder correctamente una pregunta al azar es de
# 1/5=0.2, Podemos encontrar la probabilidad de tener exactamente 
# 4 respuestas correctas por intentos aleatorios de la siguiente
# manera:
...
# 2.- Espacio muestral (12 preguntas e total)
...
# Rejilla de valores del eje X, **x=80**. Se van a utilizar el mismo 
# valor de "x", de "n" y la probabilidad es la que va a ir cambiando,
# en esta ocasión se ocuparán las probabilidades de 
...
# Suponga que hay doce preguntas de opción múltiple en un examen de 
# matemáticas. Cada pregunta tienecinco posibles respuestas, y sólo 
...
# Solución 2: Para que saque una respuesta más o menos correcta

# Para encontrar la probabilidad de tener cuatro o menos respuestas 
# correctas de forma aleatoria se utiliza la función 
...
# NOTA 1: Se pone la leyenda en el centro del gráfico, buscando la 
# manera en la que no se pierda ningún dato.
...
# 2.- Supongamos que la empresa Apple fabricó el Iphone 11S con una
# probabilidad de 0.005 de ser defectuoso.
# El producto se envía en una caja que contiene 25 artículos. 
# ¿Cuál es la probabilidad de que una caja elegidaal azar contenga 
...
# Rejilla de valores del eje X, x=0:50. Se van a utilizar el mismo 
# de valor de “x”, y lambda es la que va a ir cambiando, en esta
# ocasión se ocuparán valores de 5, 10 y 20. Además de poner la
# leyenda.
x <- 0:50
...
# de una Escuela Primaria en un lapso de 15 minutos a la entrada de 
# la escuela. Se puede suponer que la probabilidad de llegada de los 
# estudiantes es la misma que cualquiera de los dos lapsos con la 
# misma dirección siendo estas independientes a que llegue o no el 
# estudiante. El número promedio de alumnos que llegan en un lapso 
# de 15 minutos son 35. Para optimizar la llegada de los estudiantes
# evitando las aglomeraciones se requiere saber la probabilidad de 
...
# 2.- ¿Cuál es la probabilidad de que a la salida de la escuela, se
# encuentren 60 alumnos en 5 minutos?
...
# 3.- ¿Cuál es la probabilidad de que a la salida de la escuela, se
# encuentren 120 alumnos en 5 minutos?
...
# sin embargo se debe modificar el valor de lambda
# para que se pueda observar bien el gráfico, pero el valor de “x” 
# sigue igual, además de que la leyenda también
# cambia.
plot(dpois(0:120, 5), type = "h", lwd = 2,
