...
# 1. Ejemplo: Tenemos 100 estudiantes y se quieren agrupar en equipos
# de 2 integrantes cada uno.
...
# 2. Determinar que vayan los números con ID número consecutivo.
# En esta ocasión, el objeto se llamará "alumnos"
...
# 1. Se requiere realizar equipos de 4 integrantes con los alumnos de 
# cuarto grado de la escuela primaria "Emiliano Zapata". En total se
# tienen 72 alumnos 

# N = 72 - Número de elementos
...
# 1. Se requiere realizar equipos de 3 integrantes con los alumnos de 
# cuarto grado de la escuela primaria "Emiliano Zapata". En total se
# tienen 75 alumnos 

# N = 72 - Número de elementos

# n = 4 - Grupos de 2 en 2 
