...
#Para conocer el nombre de las columnas de nuestra base de datos, se ocupa:
 # **colnames (BD)**
...
#Se utiliza el siguiente comando para saber la dimensión de la matriz: **dim(BD)**
...
#Para observar las variables y el tipo, que tenemos ocupamos: **str(penguins)**

str(penguins)


#5.- Enbusca de datos perdidos 
...
#1.-Seleccionar las variables que vayamos a correlacionar, ocupamos:
 # **str(penguins)**
...
#2.- Se seleccionan las filas 1 a la 61, que corresponden a la especie Adeli y las variables cuantitativas.
...
#6.1 Se genera un nuevo objeto con el no,mbre de Pearson, es decir,
...
#Se utiliza el siguiente comando para saber la dimensión de la matriz:
 # **dim(BD)**
...
#  rate, minutos, budget y gross.worldwide, con:
 ...
 # *Nota: elegimos columnas nuevas debido a que la número 4 y la 6 son carácteres y necesitamos utilizar númericas.
...
#6.- Verificar que el nombre de las variables esten correctas utilizando:
 # **colnames(marvel)**
...
#10.- Se utiliza la función kable para tabla en formato markdown
# **kable(spearman)**
